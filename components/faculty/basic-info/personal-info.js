      ...
      return (
        <div className="row pb-3">
          <div className="form-group col-md-4 required">
            <label className="control-label" htmlFor="Dependent">
              {" "}
              Name of Dependent{" "}
            </label>
            <input
          ...
          <div className="form-group col-md-4 required">
            <label className="control-label" htmlFor="DependentDateOfBirth">
              {" "}
              Date of Birth{" "}
            </label>
            <input
          ...
          <div className="form-group col-md-4 required">
            <label className="control-label" htmlFor="DependentRelationship[]">
              {" "}
  ...
  return (
    <div style={{ background: "var(--color-background" }}>
      <div className="card">
        ...
        <NameDisplay unit={props.unit} position={props.position}>
          {name}
        </NameDisplay>
        <Formik
              ...
              <div className="row pb-3">
                ...
                <div className="form-group col-md-6">
                  ...
                  <Field
                    ...
                    type="email"
                    name="upemail"
                    defaultValue={FacultyDetails.upemail}
                    disabled="true"
                  />
                </div>
              </div>
              ...
              <div className="row pb-3">
                <div className="form-group col-md-12 required">
                  ...
                  <Field
                    ...
                    defaultValue={FacultyDetails.teachingPhilosophy}
                    disabled={!props.editable}
                    required
                  />
                </div>
