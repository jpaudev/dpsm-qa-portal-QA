...
async function getServerSideProps(context) {
  ...
  if (context.res) {
    if ((0,_helpers__WEBPACK_IMPORTED_MODULE_9__/* .isExpired */ .B)(token.user) || Object.keys(token).length === 0 && token.constructor === Object) {
      return {
        redirect: {
          destination: '/login',
          permanent: false
...
var __webpack_exports__ = __webpack_require__.X(0, [664,287,752,429,939,992], function() { return __webpack_exec__(8160); });
